...
PLATFORM_LDFLAGS = -Wl,--as-needed -Wl,--gc-sections --preload-file bin/data@data --emrun --bind -s ALLOW_MEMORY_GROWTH=1 -s TOTAL_MEMORY=1600MB -s WASM=0 -s NO_EXIT_RUNTIME=1 --profiling-funcs
