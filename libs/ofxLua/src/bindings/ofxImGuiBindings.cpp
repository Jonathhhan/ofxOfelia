...
static int _wrap_Gui_setup__SWIG_2(lua_State* L) { { int SWIG_arg = 0; ofxImGui::Gui *arg1 = (ofxImGui::Gui *) 0 ;
  ...
  lua_error(L); return 0; }
static int _wrap_Gui_setup(lua_State* L) { int argc; int argv[4]={ 1,2,3,4} ; argc = lua_gettop(L); if (argc == 1) {
    return _wrap_Gui_setup__SWIG_2(L);}  if (argc == 2) { return _wrap_Gui_setup__SWIG_1(L);}  if (argc == 3) {
    return _wrap_Gui_setup__SWIG_0(L);}  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'Gui_setup'\n"
...
static int _wrap_Gui_loadImage(lua_State* L) { int argc; int argv[3]={ 1,2,3} ; argc = lua_gettop(L); if (argc == 2) {
    int _v = 0; { { void *ptr;
        if (lua_isuserdata(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_ofImage, SWIG_POINTER_NO_NULL)) {
          _v = 0; }  else { _v = 1; }  } }  if (!_v) goto check_1; return _wrap_Gui_loadImage__SWIG_0(L);}  check_1:
  if (argc == 2) { return _wrap_Gui_loadImage__SWIG_1(L);} 
...
static int _wrap_Gui_loadPixels(lua_State* L) { int argc; int argv[3]={ 1,2,3} ; argc = lua_gettop(L); if (argc == 2) {
    int _v = 0; { { void *ptr;
        if (lua_isuserdata(L,argv[1])==0 || SWIG_ConvertPtr(L,argv[1], (void **) &ptr, SWIGTYPE_p_ofPixels, SWIG_POINTER_NO_NULL)) {
          _v = 0; }  else { _v = 1; }  } }  if (!_v) goto check_1; return _wrap_Gui_loadPixels__SWIG_1(L);}  check_1:
  if (argc == 2) { return _wrap_Gui_loadPixels__SWIG_0(L);} 
...
static int _wrap_Gui_loadTexture(lua_State* L) { int argc; int argv[4]={ 1,2,3,4} ; argc = lua_gettop(L); if (argc == 2) {
    return _wrap_Gui_loadTexture__SWIG_0(L);}  if (argc == 3) { return _wrap_Gui_loadTexture__SWIG_1(L);} 
